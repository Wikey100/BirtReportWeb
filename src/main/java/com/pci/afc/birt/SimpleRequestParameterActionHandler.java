...
public class SimpleRequestParameterActionHandler implements IHTMLActionHandler {
    ...
    public SimpleRequestParameterActionHandler(String reportNameKey, String formatKey) {
        ...
        urlBuilderMap.put(IAction.ACTION_BOOKMARK, (actionType, actionDefn, ctx) -> {
            if (actionDefn.getActionString() != null)
                return "#" + actionDefn.getActionString();
            return null;
        });
        urlBuilderMap.put(IAction.ACTION_HYPERLINK, (actionType, actionDefn, ctx) -> actionDefn.getActionString());
        urlBuilderMap.put(IAction.ACTION_DRILLTHROUGH, (actionType, actionDefn, ctx) -> buildDrillAction(actionDefn, ctx));
    }
